...
abstract class BaseCountry extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('name, c_code', 'length', 'max'=>255),
			array('name, c_code, order', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id, name, c_code, order', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search() {
		...
		$criteria->compare('c_code', $this->c_code, true);
