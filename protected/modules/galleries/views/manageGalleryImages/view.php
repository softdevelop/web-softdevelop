...
<?php $this->widget('zii.widgets.CDetailView', array(
	...
	'attributes' => array(
		...
		array(
					'name' => 'gallery',
					'type' => 'raw',
					'value' => $model->gallery !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->gallery)), array('galleries/view', 'id' => GxActiveRecord::extractPkValue($model->gallery, true))) : null,
					),
		'name',
		//'image',
		array(
			'label'=>'image',
			'type' => 'raw',
			'value' => CHtml::image(Yii::app()->CreateUrl('/') .'/wwwroot/upload_files/galleries/images/' .$model->image,'alt', array('class'=>"view_image")),
		),
		'description',
		'create_time',
		'update_time',
