...
<h2><?php //echo GxHtml::encode($model->getRelationLabel('services')); ?></h2>
<?php
	/*echo GxHtml::openTag('ul');
	foreach($model->services as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('services/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
