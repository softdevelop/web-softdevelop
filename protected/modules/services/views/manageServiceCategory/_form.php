	...
	<?php echo $form->errorSummary($model); ?>
		...
		<script type="text/javascript" language="javascript">
            jQuery(document).ready(function() {
                $('#ServiceCategory_name').keyup(function(){
                    createAlias();
                });
                $('#ServiceCategory_name').focusout(function(){
                    createAlias();
                });
								
				function createAlias() {
                    var value = $('#ServiceCategory_name').val();
                    ...
                    $('#ServiceCategory_alias').val(value);
                };
            });
        </script>
		<div class="row">
		...
		<label><?php //echo GxHtml::encode($model->getRelationLabel('services')); ?></label>
		<?php //echo $form->checkBoxList($model, 'services', GxHtml::encodeEx(GxHtml::listDataEx(Services::model()->findAllAttributes(null, true)), false, true)); ?>
